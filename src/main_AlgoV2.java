    ...
    public static void main(String[] args) {
        ...
        for (int index3 = 1; index3 <= 10; index3++) {
            ...
            for (int index = 0; index < size; index++) {
                int time = 100;
                if (index < size - 1) {
                    Simulator sim = new Simulator("simtest_" + index+(index3*100), 0.1, 10, time, b.getPh(), b.getDo2(), b.getTemp(),10);
                    ...
                    b = ga.Get_Best_Param();
                    Simulator sim = new Simulator("Bestresult" + index3, 0.1, 10, time, b.getPh(), b.getDo2(), b.getTemp(),10);
                    sim.Simulation();
                }
            }
        }
